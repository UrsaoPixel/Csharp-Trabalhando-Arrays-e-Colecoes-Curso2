...
using bytebank_ATENDIMENTO.bytebak.Exceptions;
        ...
        private List<ContaCorrente> _listaDeContas = new List<ContaCorrente>()
{
    ...
    new ContaCorrente(94, "987321-W") {Saldo=600, Titular = new Cliente{Cpf ="33333", Nome="Marisa"}}
};
        ...
        public void AtendimentoCliente()
        {
            try
            {
                ...
                while (opcao != '6')
                {
                    ...
                    Console.WriteLine("====4 - Ordernar Conta    ====");
        ...
        private void PesquisarContas()
        {
            ...
            Console.WriteLine("===============================");
            Console.WriteLine("\n");
            Console.Write("Deseja pesquisar por (1) NUMERO DA CONTA, (2)CPF TITULAR ou (3) N° Agência ? ");
